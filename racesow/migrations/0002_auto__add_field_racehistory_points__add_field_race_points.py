...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RaceHistory.points'
        db.add_column(u'racesow_racehistory', 'points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Race.points'
        db.add_column(u'racesow_race', 'points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RaceHistory.points'
        db.delete_column(u'racesow_racehistory', 'points')

        # Deleting field 'Race.points'
        db.delete_column(u'racesow_race', 'points')
