...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.maps_finished'
        db.add_column(u'racesow_player', 'maps_finished',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Player.points'
        db.add_column(u'racesow_player', 'points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'RaceHistory.rank'
        db.add_column(u'racesow_racehistory', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Race.rank'
        db.add_column(u'racesow_race', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Map.compute_points'
        db.add_column(u'racesow_map', 'compute_points',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Map.last_computation'
        db.add_column(u'racesow_map', 'last_computation',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.maps_finished'
        db.delete_column(u'racesow_player', 'maps_finished')

        # Deleting field 'Player.points'
        db.delete_column(u'racesow_player', 'points')

        # Deleting field 'RaceHistory.rank'
        db.delete_column(u'racesow_racehistory', 'rank')

        # Deleting field 'Race.rank'
        db.delete_column(u'racesow_race', 'rank')

        # Deleting field 'Map.compute_points'
        db.delete_column(u'racesow_map', 'compute_points')

        # Deleting field 'Map.last_computation'
        db.delete_column(u'racesow_map', 'last_computation')
